...
public class MainActivity extends AppCompatActivity {
    ...
    String[] fromLanguages = {"From", "English", "Africaans", "Arabic", "Belarusian", "Bulgarian", "Bengali",
            "Catalan", "Czech", "Welsh", "Urdu", "Russian"};

    String[] toLanguages = {"To", "English", "Africaans", "Arabic", "Belarusian", "Bulgarian", "Bengali",
            "Catalan", "Czech", "Welsh", "Urdu", "Russian"};
    ...
    private void translateText(int fromLanguageCode, int toLanguageCode, String source){
        translatedTV.setText("Downloadind Modal...");
